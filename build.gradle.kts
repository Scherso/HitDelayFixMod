...
loom {
    ...
    launchConfigs {
        getByName("client") {
            ...
            property("fml.coreMods.load", "io.ghast.hitdelayfix.FMLPlugin")
            arg("-Dfml.coreMods.load", "io.ghast.hitdelayfix.FMLPlugin")
        }
    }
...
tasks.named<Jar>("jar") {
    ...
    manifest.attributes.run {
        ...
        this["FMLCorePlugin"] = "io.ghast.hitdelayfix.FMLPlugin"
        this["ModType"] = "FML"
